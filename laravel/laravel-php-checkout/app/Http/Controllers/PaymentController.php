...
{
    public function createPaymentIntent(Request $request, $accountId): JsonResponse
    {
        try {
    ...
    // Add function for confirming PI as well, but comment out but provide documentation in readme.
}